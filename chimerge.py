...
# THRESHOLD = X^2 taken accordingly based on degrees of freedom (number of classes -1 ) and ~.90 significance level
# MAX_INTERVALS = 6
...
class ChiMerge():
    ...
    def loadData(self, data, issorted=False):
        ...
        :param attribute_column: index (starting from 0) of the column to be used as attribute values
        :param attribute_class_column: index (starting from 0) of the column to be used as class values (these values should contain integers)
